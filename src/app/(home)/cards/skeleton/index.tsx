...
export function CardsSkeletonDemo() {
	return (
		<div
			data-slot="demo"
			className="theme-neutral relative flex w-full max-w-none flex-col gap-(--gap) bg-muted p-12 pb-0! 3xl:[--gap:--spacing(8)] [--gap:--spacing(8)] lg:p-8 xl:p-12 dark:bg-muted/30 lg:[--gap:--spacing(6)] min-[1900px]:[--gap:--spacing(10)]!"
		>
			<div className="relative z-10 mx-auto grid grid-cols-1 gap-(--gap) **:data-[slot=card]:w-full md:max-w-3xl md:grid-cols-2 lg:max-w-none lg:grid-cols-3 xl:max-w-[1600px] 2xl:max-w-[1920px] min-[1400px]:grid-cols-4! min-[1900px]:grid-cols-5!">
