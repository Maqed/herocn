...
<RenderCSSShared
  light={["--default", "--default-foreground", "--destructive-foreground"]}
  ...
  css={["@utility pressible", "@utility focus-field-ring", "@utility invalid-field-ring", "@utility invalid-field-ring-focus"]}
/>
