...
function DropdownMenuLabel({
  ...
  return (
    <MenuPrimitive.GroupLabel
      ...
      data-inset={inset}
      className={cn(
        "text-muted-foreground px-3 py-1.5 text-xs font-medium data-inset:pl-7",
        className,
      )}
      {...props}
    />
