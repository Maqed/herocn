...
<CodeBlockCommand command="npx shadcn@latest add @herocn/avatar" />
...
Use the `AvatarBadge` component to add a badge to the avatar. Serves the same purpose as [HeroUI v3 badge](https://v3.heroui.com/docs/react/components/badge)
