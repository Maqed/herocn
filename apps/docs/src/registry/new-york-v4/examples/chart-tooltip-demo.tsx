...
function TooltipDemo({
	...
	return (
		<div
			className={cn(
				"grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-border/50 bg-background px-2.5 py-1.5 text-xs shadow-xl transition-transform ease-in-out hover:-translate-y-0.5",
				className,
			)}
		>
