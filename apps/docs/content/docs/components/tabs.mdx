...
<CodeBlockCommand command="npx shadcn@latest add https://herocn.dev/r/tabs.json" />
...
<RenderCSSShared
  light={["--default", "--surface", "--segment", "--segment-foreground"]}
  dark={["--default", "--surface", "--segment", "--segment-foreground"]}
  theme={["--color-default", "--color-surface", "--color-segment", "--color-segment-foreground"]}
