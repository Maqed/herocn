...
<RenderCSSShared
  light={["--surface", "--default", "--default-foreground", "--destructive-foreground"]}
  dark={["--surface", "--default", "--default-foreground", "--destructive-foreground"]}
  theme={["--color-surface", "--color-default", "--color-default-foreground", "--color-destructive-foreground"]}
...
<ApiRefTable
  props={[
    {
      name: "size",
      type: '"icon-xs" | "icon" | "default" | "sm" | "lg"',
      defaultValue: '"icon-xs"',
      description: "The button size.",
    },
    {
      name: "variant",
      type: '"default" | "primary" | "success" | "warning" | "destructive" | "outline" | "ghost"',
      defaultValue: '"ghost"',
