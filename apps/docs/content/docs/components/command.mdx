...
<CodeBlockCommand command="npx shadcn@latest add https://herocn.dev/r/command.json" />
...
<CodeBlockCommand command="npm install cmdk" />
...
<ComponentPreview name="command-overlay-variant" />
