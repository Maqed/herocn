...
const navigationMenuTriggerStyle = cva(
	"pressible no-highlight focus-visible:focus-ring group/navigation-menu-trigger inline-flex h-9 w-max cursor-pointer select-none items-center justify-center rounded-2xl px-4.5 py-2.5 font-medium text-sm outline-none transition-all hover:bg-muted disabled:pointer-events-none disabled:opacity-50 data-popup-open:bg-muted/50 data-open:hover:bg-muted data-popup-open:hover:bg-muted",
);
