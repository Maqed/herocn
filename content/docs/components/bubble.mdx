...
<RenderCSSShared
  light={["--primary-soft", "--primary-soft-foreground"]}
  dark={["--primary-soft", "--primary-soft-foreground"]}
  theme={["--color-primary-soft", "--color-primary-soft-foreground"]}
...
| `soft`      | A subtle primary-soft bubble.                        |
...
<ApiRefTable
  props={[
    {
      name: "variant",
      type: '"default" | "secondary" | "muted" | "soft" | "outline" | "ghost" | "destructive"',
