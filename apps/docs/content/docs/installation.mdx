...
<CodeBlockCommand command="npx shadcn@latest init https://herocn.dev/r/style.json" />
...
<CodeBlockCommand command="npx shadcn@latest add https://herocn.dev/r/ui.json" />
...
<CodeBlockCommand command="npx shadcn@latest add https://herocn.dev/r/style.json" />
