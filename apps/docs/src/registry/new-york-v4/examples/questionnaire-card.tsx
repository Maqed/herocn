		...
		>
			<Card>
				<QuestionnaireItem aria-labelledby={taskTitleId} name="task" required>
					...
					<CardContent>
						<QuestionnaireChoices>
							<QuestionnaireChoice variant="secondary" value="fix">
								Fix the failing tests
							</QuestionnaireChoice>
							<QuestionnaireChoice variant="secondary" value="refactor">
								Refactor the data layer
							</QuestionnaireChoice>
							<QuestionnaireChoice variant="secondary" value="docs">
				...
				>
					...
					<CardContent>
						<QuestionnaireChoices>
							<QuestionnaireChoice variant="secondary" value="summary">
								Summary only
							</QuestionnaireChoice>
							<QuestionnaireChoice variant="secondary" value="files">
								Summary and changed files
							</QuestionnaireChoice>
							<QuestionnaireChoice variant="secondary" value="review">
								Full review handoff
							</QuestionnaireChoice>
						</QuestionnaireChoices>
						<QuestionnaireError />
