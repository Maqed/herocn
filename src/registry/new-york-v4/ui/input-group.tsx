	...
	return (
		<div
			...
			className={cn(
				...
				"hover:not-focus-within:bg-input/40 not-dark:data-[variant=secondary]:brightness-100 hover:not-focus-within:data-[variant=secondary]:bg-default not-dark:hover:not-focus-within:data-[variant=secondary]:brightness-96 dark:hover:not-focus-within:bg-input dark:hover:not-focus-within:data-[variant=secondary]:bg-default",
				className,
			)}
			{...props}
		/>
